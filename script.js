...
const WORDS = [
  ...
  {
    word: "桜吹雪", lang: "日語", origin: "來自日語",
    color: { hex: "#F2C9D0", name: "退紅", romaji: "TAIKO" },
    quote: "「不是一朵花的落下，而是整個春天同時說再見——漫天粉色的雪，在你張開手掌之前，已經落進了泥土裡。」",
    keys: ["櫻花","花瓣","飄落","春天","漫天","粉色","花雨","春風","盛開又凋謝","紛紛落","花瓣紛飛","滿天","紛飛","凋謝","落花","櫻雪","吹雪","花吹雪"]
  }
];
